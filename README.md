...
Список доступных параметров [MLPClassifier](https://scikit-learn.org/stable/modules/generated/sklearn.neural_network.MLPClassifier.html), с учетом не достаточно высокого знания английского, могу ошибаться в трактовке:
